...
function pipelineRun() {
  ...
  PipelineRunCreator.createNew = function (feedEntry) {
    ...
    function mapInfoText() {
      ...
      var theTime = moment(pipelineRun.updated).format('HH:mm:ss, MMMM Do YYYY');
      ...
      pipelineRun.info = '[' + pipelineRun.buildNumber + '] ' + theResult + ' | ' + theAuthor + ' | ' + theCommit + ' | ' + theTime;
    ...
    function findStageById(stageId) {
      return _.find(pipelineRun.stages, { id: stageId });
    }
