  ...
  PipelineRunCreator.createNew = function (feedEntry) {
    ...
    function promiseRunStats() {
      ...
      function promiseJobDetails() {
        ...
        return globalOptions.getGocdRequestor().getJobRunDetails(stageUrls);
      }
    ...
    function promiseInitialise() {
      ...
      try {
        return addStage(feedEntry)
          ...
          .then(promiseRunStats);

      } catch(err) {
        console.log('Error initialising pipeline run', err);
      }
