...
function pipelineRun() {
  ...
  PipelineRunCreator.createNew = function (runData) {
    ...
    function mapInfoText() {
      ...
      var lastCommitMaterial = pipelineRun['build_cause']['material_revisions'][0].modifications[0];
    ...
    function mapPipelineAuthor() {
      ...
      var modifications = _.flatten(_.map(buildCause['material_revisions'], 'modifications'));
