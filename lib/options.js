...
function optionsModule() {
  ...
  var getPipelineBasePath = function(pipeline) {
    return '/go/api/pipelines/' + (pipeline || options.pipeline);
  };

  var getHistoryPath = function(pipeline) {
    return getPipelineBasePath(pipeline) + '/history';
  };

  var getSnapHistoryEndpoint = function(pipeline) {
  ...
  var getCcTrayPath = function(pipeline) {
    if(useSnap()) {
      return '/' + (pipeline || options.pipeline) + '/branch/master/cctray.xml';
    } else {
