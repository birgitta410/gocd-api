...
function optionsModule() {
  ...
  return {
    ...
    getHistoryEndpoint: getHistoryEndpoint,
    getPipelineBasePath: getPipelineBasePath
  };
};
...
exports.getHistoryEndpoint = options.getHistoryEndpoint;
exports.getPipelineBasePath = options.getPipelineBasePath;